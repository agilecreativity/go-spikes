...
func main() {
	...
	fmt.Println(r.FindStringSubmatch("peach punch"))                   // [peach]
	fmt.Println(r.FindStringSubmatchIndex("peach punch"))              // [0 5]
	fmt.Println(r.FindAllString("peach punch pinch", -1))              // [peach punch pinch]
	fmt.Println(r.FindAllStringSubmatchIndex("peach punch pinch", -1)) // [[0 5] [6 11] [12 17]]
